...
This project is indexed by GitNexus as **marketplace-dev-public-authorization**. Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
