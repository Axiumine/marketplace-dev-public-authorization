 ...
 *
 * ⚠️ **Nothing here configures TLS, and nothing here may.** This file used to hand `Sentry.init` a
 ...
 * resolves to `httpBodies: ["incomingRequest", …]`, every request on this platform is a GraphQL
