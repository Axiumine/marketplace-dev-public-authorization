...
export interface IShopOwnerLoginCheckData {
	...
	deleted?: Date
	/**
	 * BC-03's approval gate, raised by an admin to park the account pending review — and by
	 ...
	 * block is written only by `shopOwnerRegister`: a shop owner an admin created through
